...
- [X] User Input Validation : Throw an error if an expense amount is not a number
- [X] User Input Validation : Throw an error if an expense label or spender is a number
